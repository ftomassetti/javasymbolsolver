...
//        }
    ...
    public void functionalInterfaceParameterizationInference(LambdaExpr lambdaExpr,
        ...
        List<InferenceVariable> alphas = InferenceVariable.instantiate(interfaceDeclaration.getTypeParameters().size());
        ...
        for (int i=0; i<n; i++) {
            ...
            //constraintFormulaSet = constraintFormulaSet.addConstraint(new TypeSameAsType(pi, qi));
        }
